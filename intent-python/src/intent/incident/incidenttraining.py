    ...
    def db_insert_training_tickets( customer_id,dataset_name,team_name,trainingMode):
        ...
        if (custom_incidenttraining_flag=='failure'):
            ...
            if trainingMode=='EDA':
                ...
                # if algoname == algopickle:

                #     TrainingTbl['PredictedFields'][0]["Algorithms"][0]["PredictionPklFile"] = f"{customername}__{dataset_name}__{algoname}__{predfield}__Approved__Model.pkl"
