...
class ITSMUpdate:
    ...
    def snow_update_fields(self, customer_id, dataset_id, itsm_details):
        try:
            ...
            logging.error('someField is not defined in "config/intent.ini" file. Define it for Assignee Prediction')
...
class ITSMAdapter(object):
    ...
    def __init__(self, itsm_details, customer_id=False, dataset_id=False, data=False):
        ...
        '''
        self.itsm_details = itsm_details
        # self.custom_invocation = custom_invocation
        self.customer_id = customer_id
        self.dataset_id = dataset_id
        self.data = data
        ...
        if (user_status == 'Logged in'):
            ...
            if (login_user):
                ...
                if (custom_itsm_flag == 'failure'):
                    ...
                    # req_response = requests.get(api, params={'user_id': user},proxies=proxies)
    ...
    def notifications(incidentToUpdate, ticket_id_field_name):
        ...
        try:
            if incidentToUpdate['priority'] == '':
                ...
                #incidentToUpdate[ticket_id_field_name] +
        ...
        if (msteams == "true"):
            ...
            try:               
                ...
                if len(accounts) > 0:
                    ...
                    # print("result in len(accounts)---------",result)
                ...
                #access_token_id=config["Notification"]["access_token_id"]
