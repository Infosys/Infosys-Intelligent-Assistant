...
class SQLPersistence(object):
    ...
    def connectToDB(self):
        ...
        #self.cnx = mysql.connector.connect(user=user, password=password, port=port, host=host, database=name);
        
        #self.engine = create_engine('mysql+mysqlconnector://'+user+':'+password+'@'+host+':'+port+'/'+name, echo=False)
