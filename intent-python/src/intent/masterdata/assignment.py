...
from intent.masterdata.assignment_adapter import AssignmentAdapter
    ...
    def assignmentRouting(self):
        try:
            ...
            obj = AssignmentAdapter(resourceCount,applicationCount,mappingTableCount,customer_id = self.customer_id,\
                dataset_id=self.dataset_id,mapping_assignemnt= self.mapping_assignemnt,possible_assignee=self.possible_assignee,\
