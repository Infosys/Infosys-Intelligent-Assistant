...
class AlgorithmMasterData(object):
    ...
    #@app.route("/getAlgoDefaultParams/<int:customer_id>/<int:dataset_id>/<parameter_type>", methods=['GET'])
    @staticmethod
    def getAlgoDefaultParams( customer_id,dataset_id,parameter_type):
        user_param_choices = {}
    ...
    #@app.route("/changeAlgorithm/<int:customer_id>/<int:algorithm_id>", methods=["PUT"])
    @staticmethod
    def changeAlgorithm( customer_id, algorithm_id):
        #customer_tbl is a pymongo object to TblCustomer
        #print('Inside Change Algorithm')
    ...
    #@app.route("/algorithms/<int:customer_id>/<int:dataset_id>/<status>",methods=["GET"])
    @staticmethod
    def getAlgorithms(customer_id,dataset_id,status):
    ...
    #@app.route("/chosenAlgorithms/<int:customer_id>/<int:dataset_id>/<status>",methods=["GET"])
    @staticmethod
    def getChosenAlgorithms( customer_id,dataset_id,status):
        result = {}
