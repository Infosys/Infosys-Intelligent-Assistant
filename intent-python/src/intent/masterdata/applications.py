...
class ApplicationMasterData(object):
    ...
    #@app.route('/uploadApplicationDetails/<int:customer_id>/<team_name>', methods=["POST"])
    @staticmethod
    def db_insert_application_details( customer_id,team_name):
    ...
    #@app.route("/segmentID/<assignment_group>",methods=["GET"])
    @staticmethod
    def getSegmentId( assignment_group):
    ...
    #@app.route('/getApplicationDetails/<int:customer_id>/<team_name>',methods=['GET'])
    @staticmethod
    def get_application_details( customer_id,team_name):
        try:
