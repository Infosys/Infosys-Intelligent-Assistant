...
from intent.crypt.crypt import decrypt_credentials
from intent.utils.mongdb_helper import get_records_from_db
...
try:
    ...
    config = {  "mail_type" : True,
                "server" : "keccas.ad.infosys.com"
             }
    log.debug(config)

cert_file_path = 'cert/cacerts.pem'
